 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `YYLRModel` protocol for custom methods.
 
 
 Sample Code:
    
     ********************** json convertor *********************
     @interface YYLRAuthor : NSObject
     @property (nonatomic, strong) NSString *name;
     @property (nonatomic, assign) NSDate *birthday;
     @end
     @implementation YYLRAuthor
     @end
 
     @interface YYLRBook : NSObject
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) NSUInteger pages;
     @property (nonatomic, strong) YYLRAuthor *author;
     @end
     @implementation YYLRBook
     @end
    
     int main() {
         // create model from json
         YYLRBook *book = [YYLRBook yylr_modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
 
         // convert model to json
         NSString *json = [book yylr_modelToJSONString];
         // {"author":{"name":"J.K.Rowling","birthday":"1965-07-31T00:00:00+0000"},"name":"Harry Potter","pages":256}
     }
 
     ********************** Coding/Copying/hash/equal *********************
     @interface YYLRShadow :NSObject <NSCoding, NSCopying>
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) CGSize size;
     @end
 
     @implementation YYLRShadow
     - (void)encodeWithCoder:(NSCoder *)aCoder { [self yylr_modelEncodeWithCoder:aCoder]; }
     - (id)initWithCoder:(NSCoder *)aDecoder { self = [super init]; return [self yylr_modelInitWithCoder:aDecoder]; }
     - (id)copyWithZone:(NSZone *)zone { return [self yylr_modelCopy]; }
     - (NSUInteger)hash { return [self yylr_modelHash]; }
     - (BOOL)isEqual:(id)object { return [self yylr_modelIsEqual:object]; }
     @end
 
 */
@interface NSObject (YYLRModel)
 ...
 */
+ (nullable instancetype)yylr_modelWithJSON:(id)json;
+ (nullable instancetype)yylr_jsonObjWithString:(NSString *)jsonString;
/**
 ...
 property, this method will try to convert the value based on these rules:
     ...
     `NSString` -> SEL, Class.
 */
+ (nullable instancetype)yylr_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (nullable id)yylr_modelToJSONObject;
 ...
 */
- (nullable NSData *)yylr_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)yylr_modelToJSONString;
 ...
 */
+ (nullable NSArray *)yylr_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (YYLRModel)
 ...
 */
+ (nullable NSDictionary *)yylr_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
...
/**
 ...
 There's no need to add '<YYLRModel>' to your class header.
 */
@protocol YYLRModel <NSObject>
@optional
...
/**
 ...
 object will be add to the array/set/dictionary.
  ...
  Example:
        @class YYLRShadow, YYLRBorder, YYLRAttachment;
 
        @interface YYLRAttributes
        @property NSString *name;
        ...
        @implementation YYLRAttributes
        + (NSDictionary *)modelContainerPropertyGenericClass {
            return @{@"shadows" : [YYLRShadow class],
                     @"borders" : YYLRBorder.class,
                     @"attachments" : @"YYLRAttachment" };
        }
        @end
...
/**
 ...
 Example:
        @class YYLRCircle, YYLRRectangle, YYLRLine;
 
        @implementation YYLRShape

        + (Class)modelCustomClassForDictionary:(NSDictionary*)dictionary {
            if (dictionary[@"radius"] != nil) {
                return [YYLRCircle class];
            } else if (dictionary[@"width"] != nil) {
                return [YYLRRectangle class];
            } else if (dictionary[@"y2"] != nil) {
                return [YYLRLine class];
            } else {
                return [self class];
            }
        }
